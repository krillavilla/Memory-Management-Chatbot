...
#include "chatbot.h"
#include "chatlogic.h"
#include "chatgui.h" // Add this include for ChatBotPanelDialog
...
ChatLogic::ChatLogic()
{
    ...
    // No ChatBot instance creation here
    _chatBot = nullptr;
...
ChatLogic::~ChatLogic()
{
    ...
    // No need to delete _nodes as they are now managed by unique_ptr
    // No need to delete _chatBot as it will be owned by the rootNode
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    if (file)
    {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // find all keywords for current edge
        ...
        // Move chatbot into the root node
